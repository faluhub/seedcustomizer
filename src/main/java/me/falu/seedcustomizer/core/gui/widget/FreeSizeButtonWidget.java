package me.falu.seedcustomizer.core.gui.widget;
...
public class FreeSizeButtonWidget extends ButtonWidget {
    ...
    public FreeSizeButtonWidget(int x, int y, int width, int height, Text message, PressAction onPress) {
        super(x, y, width, height, message, onPress);
    }

    public FreeSizeButtonWidget(int x, int y, int width, int height, Text message, PressAction onPress, TooltipSupplier tooltipSupplier) {
